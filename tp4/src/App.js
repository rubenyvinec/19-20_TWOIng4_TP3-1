...
},
{
    ...
    img : "https://pbs.twimg.com/profile_images/1074444120771440641/k5SsD9bT_400x400.jpg",
    likes: 0
    }
];
...
class App extends Component{
    ...
    handleLike = () => {
        if(this.state.currentProfil.prenom === "Parent"){
            profil[2].likes++;
            this.setState({currentProfil :profil[2]})
        }
        else if(this.state.currentProfil.prenom === "Claude"){
            profil[0].likes++;
            this.setState({currentProfil :profil[0]})
        }
        else if(this.state.currentProfil.prenom === "Dubois"){
            profil[1].likes++;   
            this.setState({currentProfil :profil[1]})
        }
    }
    ...
    render()
    {
        return(
            <div>
                ...
                <Like handleLike={this.handleLike} likes={this.state.currentProfil.likes} post={this.state.currentProfil.post}></Like>
            </div>
        );
    }
}
